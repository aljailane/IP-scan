    ...
    <main>
        ...
        <section class="py-5 text-center container">
            ...
            <button class="btn btn-primary" type="submit" id="button-addon2">فحص</button>
                    ...
                    <p>
                        <a href="/" class="btn btn-primary my-2">الرئيسيــــــة</a>
                        <span class="btn btn-secondary my-2">مرات الفحص <?php echo $details->completed_requests; ?></span>
                    </p>
                </div>
            </div>
        </section>
                            ...
                            <div class="card-body">
                                <p class="card-text">بيانات الزائر
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">دولته
                                        <span class="badge bg-success rounded-pill"><img id="home" src="flags/4x3/<?php echo strtolower("$details->country_code"); ?>.svg"> <?php echo $details->country; ?>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">مدينته
                                        <span
                                            class="badge bg-success rounded-pill c1"><?php echo $details->city; ?></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">منطقته
                                        <span
                                            class="badge bg-success rounded-pill c1"><?php echo $details->region; ?></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        المتصفح

                                        <span class="badge bg-success rounded-pill"><?php
                            ...
                            <div class="card-body">
                                <p class="card-text">الشبكة
                                    <li class="list-group-item d-flex justify-content-between align-items-center">شركة
                                        الاتصالات <span
                                            class="badge bg-success rounded-pill c1"><?php echo $details->org; ?></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">مزود
                                        الانترنت <span
                                            class="badge bg-success rounded-pill c1"><?php echo substr("$details->isp",4); ?></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">رمز
                                        الشبكة <span
                                            class="badge bg-success rounded-pill c1"><?php echo $details->asn; ?></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">نوع
                                        الايبي <span
                                            class="badge bg-success rounded-pill c1"><?php echo $details->type; ?></span>
                                    </li>
                                </p>
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">عاصمة
                                        البلد
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->country_capital; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">هاتف
                                        الدولة
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->country_phone; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">عملة
                                        البلد
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->currency; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">دول
                                        محيطة
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->country_neighbours; ?></b></span>
                                    </li>
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">كود
                                        العملة
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->currency_code; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">مسمى
                                        العملة
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->currency_symbol; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">سعر
                                        الصرف
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->currency_rates; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">نطق
                                        العملة
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->currency_plural; ?></b></span>
                                    </li>
                                </p>
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        التوقيت
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->timezone; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">فارق
                                        التوقيت
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->timezone_gmt; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">مسمى
                                        التوقيت
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->timezone_name; ?></b></span>
                                    </li>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">خط
                                        الطول
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->latitude; ?></b></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">خط
                                        العرض
                                        <span
                                            class="badge bg-success rounded-pill"><b><?php echo $details->longitude; ?></b></span>
                                    </li>
                                </p>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <br> <br>
                                    <iframe
                                        src="https://maps.google.com/maps?q=<?php echo $details->latitude; ?>,<?php echo $details->longitude; ?>&hl=ar;z=10&amp;output=embed"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <small class="text-muted"><a
                                            href="https://maps.google.com/maps?q=<?php echo $details->latitude; ?>,<?php echo $details->longitude; ?>&hl=ar;z=10&amp;">ذهاب
                                            الان</a></small>
                                </div>
                            </div>
                        </div>
